...
import Zepto.managers.DarkStoreManager;
import Zepto.models.DarkStore;
import Zepto.models.Product;
import Zepto.models.User;
import Zepto.strategies.ThresholdReplenishStrategy;

// Facade-ish helper: seeds the system and shows the catalogue to a user.
public class ZeptoHelper {
    ...
    public static void showAllItems(User user) {
        ...
        List<DarkStore> nearbyStores = dsManager.getNearbyDarkStores(
                user.getXCoordinate(), user.getYCoordinate(), 5.0);
